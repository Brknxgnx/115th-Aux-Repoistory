...
class CfgVehicles
{
	...
	class Aux115_Ywing: BTL_Base
	{
		author="Greg";
		scope=2;
		scopeCurator=2;
		scopeArsenal=2;
		displayName="[115] Y-Wing Bomber";
		faction="115_Faction";
		...
		{
			"\AR121-Vehicles\AR121-Air\Data\Y-wing\Chasis_Shadow_CO.paa",
			"\AR121-Vehicles\AR121-Air\Data\Y-wing\Interior_CO.paa"
		};
		class mfd
		{
			class AirplaneHUD
			{
				...
				borderTop=0;
				borderBottom=0;
				color[]={0.80000001,0.208,0.039000001,1};
		...
		class Components: Components
		{
			...
			{
				uiPicture="\AR121-Vehicles\AR121-Air\Data\Y-wing\BTLB_GUI.paa";
				class pylons
				{
					class pylons1
					{
